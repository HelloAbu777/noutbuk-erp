          ...
          <div className="sm:hidden bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 divide-y divide-gray-100 dark:divide-gray-800">
            {loading ? (
              ...
              <div key={c._id} className="p-4">
                ...
                {/* Actions */}
                <div className="flex items-center justify-around pt-2.5 mt-2.5 border-t border-gray-100 dark:border-gray-800">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead className="bg-gray-50 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                  <tr>{['Ism familiya', 'Telefon', 'Manzil', 'Qarz', 'Amallar'].map(h => (
